...
using Tools.Frontend.Presentation.Converter;
...
public class RelicMultiplierModRegionUserInterface : BaseUserInterface
{
    ...
    private Grid CreateMultiplierGroup()
    {
        ...
        {
            Path = nameof(RelicMultiplierModRegionViewModel.Multiplier),
    ...
    private ListView CreateStatusView()
    {
        ...
        var binding = new Binding
        {
            Path = nameof(RelicMultiplierModRegionViewModel.StatusMessages),
            Mode = BindingMode.OneWay,
        };
