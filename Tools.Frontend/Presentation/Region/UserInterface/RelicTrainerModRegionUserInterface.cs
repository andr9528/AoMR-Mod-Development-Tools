...
using Tools.Frontend.Presentation.Core;
...
namespace Tools.Frontend.Presentation.Region.UserInterface;

public class RelicTrainerModRegionUserInterface : BaseUserInterface
{
    private readonly RelicTrainerModRegionLogic logic;
    private readonly RelicTrainerModRegionViewModel viewModel;

    public RelicTrainerModRegionUserInterface(
        RelicTrainerModRegionLogic logic, RelicTrainerModRegionViewModel viewModel)
    {
        this.logic = logic;
    ...
    private ListView CreateStatusView()
    {
        ...
        {
            Path = nameof(RelicTrainerModRegionViewModel.StatusMessages),
