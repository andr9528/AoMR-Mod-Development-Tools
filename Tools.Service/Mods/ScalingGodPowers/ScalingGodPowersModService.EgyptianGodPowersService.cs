...
public partial class ScalingGodPowersModService
{
    private class EgyptianGodPowersService
    {
        ...
        private readonly ILogger<EgyptianGodPowersService> logger;

        public EgyptianGodPowersService(
            ToolsDatabaseContext toolsDatabaseContext, ILogger<EgyptianGodPowersService> logger)
        {
